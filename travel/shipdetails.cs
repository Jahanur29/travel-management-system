...
namespace travel
{
    public partial class shipdetails : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlDataAdapter sa = new SqlDataAdapter("select *from shipTable where tick_nmbr='" + textBox1.Text + "'or pass_name='" + textBox2.Text + "'and _date='" + dateTimePicker1.Text + "'or cabin_nmbr='" + comboBox1.Text + "'or ship_name='" + comboBox3.Text + "'", con);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            cn1.Open();
            SqlCommand cmd = new SqlCommand("delete from shipTable where tick_nmbr='" + textBox1.Text + "'", cn1);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(cns);
                con.Open();
                string qry = "select sum(tot_pass) from shipTable where _date='" + dateTimePicker1.Text + "' and ship_name= '" + comboBox3.Text + "'";
